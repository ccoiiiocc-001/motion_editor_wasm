...
cutoff = datetime.strptime('2026-06-03 15:30:00', '%Y-%m-%d %H:%M:%S').replace(tzinfo=kst).timestamp()
filtered = [i for i in instructions if i['timestamp'] < cutoff]

with open('extracted_instructions_early.json', 'w', encoding='utf-8') as f:
