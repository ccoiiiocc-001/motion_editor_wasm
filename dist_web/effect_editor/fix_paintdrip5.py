...
if start_idx != -1 and end_idx != -1:
    ...
    if (!filter) {
        // remove old
        obj.filters = obj.filters.filter(f => f.type !== 'PaintDrip');
    ...
    if (controlPanel) {
        ...
        btnStraight.innerText = 'Straight Line';
        btnStraight.innerHTML = '&#51649;&#49440; &#49345;&#45800;&#49440; &#44536;&#47532;&#44592;'; // 직선 상단선 그리기
        btnStraight.className = 'retro-action-btn';
        
        const btnCurve = document.createElement('button');
        btnCurve.innerText = 'Curve Line';
        btnCurve.innerHTML = '&#44257;&#49440; &#49345;&#45800;&#49440; &#44536;&#47532;&#44592;'; // 곡선 상단선 그리기
        btnCurve.className = 'retro-action-btn';
        
        const btnStart = document.createElement('button');
        btnStart.innerText = 'Start Effect';
        btnStart.innerHTML = '&#54952;&#44284; &#49884;&#51089;'; // 효과 시작
...
"""
    ...
    with open('js/retrofx_fixed6.js', 'w', encoding='utf-8') as f:
        f.write(code)
    print("Saved js/retrofx_fixed6.js")
